...
That long-term purpose now has a dedicated home: **GENTE-R (Resilience)**, the fifth variant in the ecosystem, whose sole function is to preserve the institutional knowledge generated by the four operational variants and transmit it to Venezuelan communities, practitioners, and institutions long after international humanitarian funding has diminished or concluded. GENTE-R is the answer to the question the other four variants cannot ask: *what happens to all this knowledge when the emergency ends?*
...
**v0.5:** GENTE-R Phase 0 — automated knowledge ingestion from all four operational variants  
**v0.6:** GENTE-R Phase 1 — SOP library, first simulation scenarios, Tier 1 community curriculum  
**v0.7:** GENTE-R Phase 2 — social media monitoring pipeline; national master trainer track  
**v1.0:** Gentoo Linux optimized deployment image; GENTE-R institutional integration with Venezuelan academic partners
